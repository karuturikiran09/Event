  ...
  //  FROM         SRegistration  Order by  dbo.SRegistration.RegistrationId desc";
    ...
    protected void gvRecord_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Delete")
        {
            ...
            // else
            // {
            string strQry = "delete From Record Where RecordId='" + e.CommandArgument.ToString() + "'";
        ...
        else if (e.CommandName == "Status")
        {
            ...
            qry += " select @s= isnull(cast(IsActive as bit),0) from SRagistration Where RecordId='" + e.CommandArgument.ToString().Trim() + "'";
            qry += " IF @s=1";
            qry += " BEGIN";
            qry += " Set @s=0";
            qry += " End";
            ...
            qry += " Set @s=1";
            qry += " End";
            qry += " Update Record set IsActive=@s where RecordId='" + e.CommandArgument.ToString().Trim() + "'";
